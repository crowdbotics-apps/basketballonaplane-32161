...
## Project Structure
    ...
    ├── basketballonaplane_32161  # Django project configurations
...
1. Clone this repo and `cd basketballonaplane_32161`
...
2. Clone this repo and `cd basketballonaplane_32161`
